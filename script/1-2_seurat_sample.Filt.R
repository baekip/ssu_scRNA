...
sample.filt <- subset(sample.orig,
...
capture.output (median(sample.filt@meta.data$nCount_RNA), file = paste0 (filt.path, "median_ExpressionSum.txt"))
capture.output (median(sample.filt@meta.data$nFeature_RNA), file = paste0 (filt.path, "median_DetectedGenes.txt"))
